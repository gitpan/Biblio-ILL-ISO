...
Biblio::ILL::ISO::Lost is a derivation of the abstract 
Biblio::ILL::ISO::ISO object, and handles the Lost message type.
...
Lost message from a file (followed by a call to
